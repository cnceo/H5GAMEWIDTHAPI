...
var Farm = (function(_super){
    ...
    _proto.init = function(){
        ...
        this.Toannounce.on("click",this,function(){
            new Annouce(1,2);
            // location = ("http://center.atjuqi.com:8088/index.html?token="+localStorage.getItem("access_token")); 
        })
        //公告消息
    ...
    _proto.onLoadHeader = function(){
        ...
        LayaSample.header = new Header(LayaSample.top.header,LayaSample.top.header.getChildByName("toggleMenu"),LayaSample.top.header.getChildByName("headerImg"),LayaSample.top.header.getChildByName("nickName"),
        LayaSample.top.header.getChildByName("woodValue"),LayaSample.top.header.getChildByName("stoneValue"),LayaSample.top.header.getChildByName("cementValue"),
        LayaSample.top.header.getChildByName("jewelValue"),LayaSample.top.header.getChildByName("toggleMenu").getChildByName("log"),
        LayaSample.top.header.getChildByName("toggleMenu").getChildByName("rank"),LayaSample.top.header.getChildByName("toggleMenu").getChildByName("recharge"),
        LayaSample.top.header.getChildByName("headerToggle"),true,6,LayaSample.top.header.getChildByName("toggleMenu").y,this.farmDatas,
        LayaSample.top.id,LayaSample.top.nickname,LayaSample.top.lv,LayaSample.top.fruitNum,LayaSample.top.expText,LayaSample.top.epxBar);
    }
    //初始化土地
    ...
    _proto.getFeedBtn = function(){
        this.feedBtn = [
            ...
            LayaSample.top.header.getChildByName("toggleMenu").getChildByName("recharge")//充值
        ]
