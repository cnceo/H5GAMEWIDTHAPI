var Header = (function(){
    ...
    function Header(header,toggleMenu,headerImg,nickName,woodValue,stoneValue,cementValue,jewelValue,log,rank,recharge,headerToggle,menuState,topMenu,noramalTop,datas,id,nichen,lvgrade,fruitNum,expText,epxBar){
    ...
    _proto.onLoad = function(){
        ...
        this.recharge.on(Laya.Event.CLICK,this,this.showRechargeDia);
        this.setHeaderPos();
        //新手引导添加
        this.start();
    };
    ...
    _proto.loadHeaderDatas = function(headerDatas){
        this.woodValue.text = headerDatas.wood
        this.stoneValue.text = headerDatas.stone
        this.cementValue.text = headerDatas.steel
        this.woodValue.text = headerDatas.money
