...
var MyHome = (function(){
    ...
    _proto.showEXCenter = function(){
        ...
        location = ("http://center.atjuqi.com:8088/tuiguang.html?token="+localStorage.getItem("access_token")); 
        return;
    ...
    _proto.toUserCenter = function(){
        ...
        location = ("http://center.atjuqi.com:8088/grzx.html?token="+localStorage.getItem("access_token")); 
        // window.open("http://www.taojingy.com/User/FindPassword","_blank");

        // var tempwindow=window.open();
        // tempwindow.location='http://www.qq.com'
    }
    //显示装扮弹出窗
